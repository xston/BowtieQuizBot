...
public class HelpCommand extends Command{
	...
	public String getHelp() {
		return "**```"
				...
				+ "help quiz             |       Information about how to host a quiz. \n\n"
				+ "help questions        |       Information about the questiontypes. \n\n"
				+ "help masters          |       Information about the master system of the bot. \n\n"
				+ "help commands         |       Information about the commands. \n\n\n"
	...
	public String getQuizHelp(){
		return "**```"
				...
				+ "'"+BotConstants.PREFIX+"setchannel #channel' command and change 'channel' to the name of desired quizchannel. \n\n"
